...
class SubPlayer : public CharactorBase
{
public:
	...
	// デストラクタ
	virtual ~SubPlayer(void) override;
...
private:
	...
	// サブプレイヤー座標
	static constexpr VECTOR SUB_PLAYER_POS = { 0.0f, 0.0f, -1150.0f };
	// サブプレイヤースケール
	static constexpr float SUB_PLAYER_SCALE = 1.0f;
	// サブプレイヤーローカル角度
	static constexpr VECTOR SUB_PLAYER_LOCAL_ROT = { 0.0f, 180.0f * DX_PI_F / 180.0f, 0.0f };
