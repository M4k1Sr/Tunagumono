...
void SubPlayer::Release(void)
{
}

void SubPlayer::InitLoad(void)
{
	// 基底クラスのリソースロード
	...
	// モデルのロード
	transform_.SetModel(
		resMng_.Load(ResourceManager::SRC::SUBPLAYER).handleId_);
}

void SubPlayer::InitTransform(void)
{
	transform_.scl = VGet(SUB_PLAYER_SCALE, SUB_PLAYER_SCALE, SUB_PLAYER_SCALE);
	transform_.quaRot = Quaternion::Identity();
	transform_.quaRotLocal = Quaternion::Euler(SUB_PLAYER_LOCAL_ROT);
	transform_.pos = SUB_PLAYER_POS;
	transform_.Update();

}

void SubPlayer::InitCollider(void)
{
	// 主に地面との衝突で使用する線分コライダ
	ColliderLine* colLine = new ColliderLine(
		ColliderBase::TAG::SUBPLAYER, &transform_,
...
void SubPlayer::InitAnimation(void)
{
	// アニメーションコントローラー
...
void SubPlayer::InitPost(void)
{

}

void SubPlayer::UpdateProcess(void)
{
	// 移動操作
	ProcessMove();
...
void SubPlayer::UpdateProcessPost(void)
{
}

void SubPlayer::ProcessMove(void)
{
...
void SubPlayer::ProcessJump(void)
{
	auto& ins = InputManager::GetInstance();
...
void SubPlayer::CollisionReserve(void)
{
	// アニメーションごとの線分調整
